...
declare %a:since("basex", "11.0") function string:jaro-winkler($string1 as xs:string, $string2 as xs:string) as xs:double external;
...
declare %a:since("basex", "10.0")
        %a:deprecated("basex", "11.0", "fn:char") function string:cr() as xs:string external;
declare %a:since("basex", "10.0")
        %a:deprecated("basex", "11.0", "fn:char") function string:nl() as xs:string external;
declare %a:since("basex", "10.0")
        %a:deprecated("basex", "11.0", "fn:char") function string:tab() as xs:string external;