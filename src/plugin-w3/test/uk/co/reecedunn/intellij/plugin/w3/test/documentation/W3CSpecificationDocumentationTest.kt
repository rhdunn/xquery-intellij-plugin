...
private class W3CSpecificationDocumentationTest {
    ...
    internal inner class FunctionsAndOperators {
        ...
        fun spec20030502() {
            val spec = FunctionsAndOperatorsDocumentation.WD_1_0_20030502
        ...
        fun spec20070123() {
            val spec = FunctionsAndOperatorsDocumentation.REC_1_0_20070123
            assertThat(spec.name, `is`("XQuery and XPath Functions and Operators"))
        ...
        fun spec20101214() {
            val spec = FunctionsAndOperatorsDocumentation.REC_1_0_20101214
            assertThat(spec.name, `is`("XQuery and XPath Functions and Operators"))
        ...
        fun spec20140408() {
            val spec = FunctionsAndOperatorsDocumentation.REC_3_0_20140408
            assertThat(spec.name, `is`("XQuery and XPath Functions and Operators"))
        ...
        fun spec20170321() {
            val spec = FunctionsAndOperatorsDocumentation.REC_3_1_20170321
            assertThat(spec.name, `is`("XQuery and XPath Functions and Operators"))
