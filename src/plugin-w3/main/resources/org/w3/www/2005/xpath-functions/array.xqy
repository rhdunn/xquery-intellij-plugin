...
declare %a:since("xpath-functions", "4.0-20210113") function array:partition($input as item()*, $break-when as function(item()*, item()) as xs:boolean) as array(*)+ external;
...
declare %a:since("xpath-functions", "4.0-20210113") function array:replace($array as array(*), $position as xs:integer, $action as function(item()*) as item()*) as array(*) external;
...
declare %a:since("xpath-functions", "4.0-20210113") function array:slice($input as array(*), $start as xs:integer?, $end as xs:integer?, $step as xs:integer?) as array(*) external;
