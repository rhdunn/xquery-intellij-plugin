...
declare %a:since("basex", "6.0") %a:since("marklogic", "5.0") function fn:concat() as xs:string external;
declare %a:since("basex", "6.0") %a:since("marklogic", "5.0") function fn:concat($arg1 as xs:anyAtomicType?) as xs:string external;
