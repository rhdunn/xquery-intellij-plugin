...
class XQueryColorSettingsPageTest {
    ...
    fun testAttributeDescriptors() {
        val settings = XQueryColorSettingsPage()
        assertThat(settings.attributeDescriptors.size, `is`(19))
        ...
        assertThat(settings.attributeDescriptors[7].displayName, `is`("Namespace Prefix"))
        assertThat(settings.attributeDescriptors[7].key, `is`(XQuerySyntaxHighlighterColors.NS_PREFIX))
        assertThat(settings.attributeDescriptors[8].displayName, `is`("Number"))
        assertThat(settings.attributeDescriptors[8].key, `is`(XQuerySyntaxHighlighterColors.NUMBER))
        assertThat(settings.attributeDescriptors[9].displayName, `is`("String"))
        assertThat(settings.attributeDescriptors[9].key, `is`(XQuerySyntaxHighlighterColors.STRING))
        assertThat(settings.attributeDescriptors[10].displayName, `is`("Direct XML Construction//Tag"))
        assertThat(settings.attributeDescriptors[10].key, `is`(XQuerySyntaxHighlighterColors.XML_TAG))
        assertThat(settings.attributeDescriptors[11].displayName, `is`("Direct XML Construction//Tag Name"))
        assertThat(settings.attributeDescriptors[11].key, `is`(XQuerySyntaxHighlighterColors.XML_TAG_NAME))
        assertThat(settings.attributeDescriptors[12].displayName, `is`("Direct XML Construction//Attribute Name"))
        assertThat(settings.attributeDescriptors[12].key, `is`(XQuerySyntaxHighlighterColors.XML_ATTRIBUTE_NAME))
        assertThat(settings.attributeDescriptors[13].displayName, `is`("Direct XML Construction//Attribute Value"))
        assertThat(settings.attributeDescriptors[13].key, `is`(XQuerySyntaxHighlighterColors.XML_ATTRIBUTE_VALUE))
        assertThat(settings.attributeDescriptors[14].displayName, `is`("Direct XML Construction//Entity Reference"))
        assertThat(settings.attributeDescriptors[14].key, `is`(XQuerySyntaxHighlighterColors.XML_ENTITY_REFERENCE))
        assertThat(settings.attributeDescriptors[15].displayName, `is`("Direct XML Construction//Escaped Character"))
        assertThat(settings.attributeDescriptors[15].key, `is`(XQuerySyntaxHighlighterColors.XML_ESCAPED_CHARACTER))
        assertThat(settings.attributeDescriptors[16].displayName, `is`("xqDoc//Tag"))
        assertThat(settings.attributeDescriptors[16].key, `is`(XQuerySyntaxHighlighterColors.XQDOC_TAG))
        assertThat(settings.attributeDescriptors[17].displayName, `is`("xqDoc//Tag Value"))
        assertThat(settings.attributeDescriptors[17].key, `is`(XQuerySyntaxHighlighterColors.XQDOC_TAG_VALUE))
        assertThat(settings.attributeDescriptors[18].displayName, `is`("xqDoc//Markup"))
        assertThat(settings.attributeDescriptors[18].key, `is`(XQuerySyntaxHighlighterColors.XQDOC_MARKUP))
    }
