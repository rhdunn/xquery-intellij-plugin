...
object XQueryTokenType {
    ...
    val K_SCHEMA_WILDCARD = IKeywordOrNCNameType("XQUERY_KEYWORD_OR_NCNAME_SCHEMA_WILDCARD", XQuery, IKeywordOrNCNameType.KeywordType.MARKLOGIC70_RESERVED_FUNCTION_NAME) // MarkLogic 7.0
