...
import uk.co.reecedunn.intellij.plugin.xquery.ast.plugin.PluginNamedMapNodeTest
import uk.co.reecedunn.intellij.plugin.intellij.lang.MarkLogic
import uk.co.reecedunn.intellij.plugin.intellij.lang.Version
import uk.co.reecedunn.intellij.plugin.intellij.lang.VersionConformance
import uk.co.reecedunn.intellij.plugin.xpath.ast.xpath.XPathStringLiteral
import uk.co.reecedunn.intellij.plugin.xdm.model.XdmItemType
import uk.co.reecedunn.intellij.plugin.xdm.model.XdmObjectNode
import uk.co.reecedunn.intellij.plugin.xdm.model.XsStringValue

class PluginNamedMapNodeTestPsiImpl(node: ASTNode) :
    ASTWrapperPsiElement(node), PluginNamedMapNodeTest, XdmItemType, VersionConformance {
    ...
    override val typeName get(): String = "object-node(\"${keyName.data}\")"
