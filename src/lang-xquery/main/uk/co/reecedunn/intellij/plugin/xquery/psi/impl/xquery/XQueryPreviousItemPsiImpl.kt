...
class XQueryPreviousItemPsiImpl(node: ASTNode) : ASTWrapperPsiElement(node), XQueryPreviousItem {
    // region PsiElement

    override fun getUseScope(): SearchScope = parent.parent.parent.useScope
