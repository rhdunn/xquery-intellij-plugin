...
object XslItemType : Language(XsltSchemaTypes, "xsl:item-type"), ISchemaType {
    // region Language
    ...
    class ParserDefinition : XPathParserDefinition() {
        override fun createParser(project: Project): PsiParser = XsltSchemaTypesParser(XslItemType)
