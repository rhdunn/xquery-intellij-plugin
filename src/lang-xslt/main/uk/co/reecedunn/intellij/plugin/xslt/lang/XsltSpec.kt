...
import uk.co.reecedunn.intellij.plugin.intellij.lang.DraftSpecification
...
object XsltSpec : ItemPresentation, XpmSpecificationType {
    ...
    val REC_1_0_19991116: XpmSpecificationVersion = XpmSpecificationVersionImpl(
        this,
        "1.0-19991116",
        "1.0",
    ...
    val REC_2_0_20070123: XpmSpecificationVersion = XpmSpecificationVersionImpl(
        this,
        "2.0-20070123",
        "2.0",
    ...
    val REC_3_0_20170608: XpmSpecificationVersion = XpmSpecificationVersionImpl(
        this,
        "3.0-20170608",
        "3.0",
