...
object XslPrefixes : Language(XsltSchemaTypes, "xsl:prefixes"), ISchemaType {
    // region Language
    ...
    class ParserDefinition : XPathParserDefinition() {
        override fun createParser(project: Project): PsiParser = XsltSchemaTypesParser(XslPrefixes)
