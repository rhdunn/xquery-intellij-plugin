...
object XslQName : Language(XsltSchemaTypes, "xsl:QName"), ISchemaType {
    // region Language
    ...
    class ParserDefinition : XPathParserDefinition() {
        override fun createParser(project: Project): PsiParser = XsltSchemaTypesParser(XslQName)

        override fun getFileNodeType(): IFileElementType = FileElementType

        override fun createFile(viewProvider: FileViewProvider): PsiFile {
            return XsltSchemaTypePsiImpl(viewProvider, XslQName)
        }
    }
