...
import uk.co.reecedunn.intellij.plugin.xslt.parser.schema.XslQNames

// NOTE: This class is private so the JUnit 4 test runner does not run the tests contained in it.
@Suppress("Reformat")
@DisplayName("XSLT 3.0 - Schema Types - xsl:QNames")
private class XslQNamesTest : ParserTestCase(XslQNames.ParserDefinition(), XPathParserDefinition()) {
