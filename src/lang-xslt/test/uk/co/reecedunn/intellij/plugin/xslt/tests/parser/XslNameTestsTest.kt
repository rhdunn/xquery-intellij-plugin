...
import uk.co.reecedunn.intellij.plugin.xslt.parser.schema.XslNameTests

// NOTE: This class is private so the JUnit 4 test runner does not run the tests contained in it.
@Suppress("Reformat")
@DisplayName("XSLT 3.0 - Schema Types - xsl:nametests")
private class XslNameTestsTest : ParserTestCase(XslNameTests.ParserDefinition(), XPathParserDefinition()) {
