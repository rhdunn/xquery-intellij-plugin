...
@Suppress("Reformat")
@DisplayName("XSLT 3.0 - Schema Types - xsl:EQName")
private class XslEQNameTest : ParserTestCase(XsltSchemaTypesParserDefinition(), XPathParserDefinition()) {
    fun parseResource(resource: String): XsltSchemaType {
        val file = ResourceVirtualFile.create(this::class.java.classLoader, resource)
        file.putUserData(ISchemaType.XDM_SCHEMA_TYPE, XsltSchemaTypes.EQName)
