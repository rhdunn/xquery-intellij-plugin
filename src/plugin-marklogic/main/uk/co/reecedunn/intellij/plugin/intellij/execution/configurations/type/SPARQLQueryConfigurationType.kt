...
class SPARQLQueryConfigurationType : ConfigurationType {
    ...
    override fun getId(): String = "XIJPSPARQLQueryProcessorConfiguration"

    override fun getDisplayName(): String = "SPARQL Query"

    override fun getConfigurationFactories(): Array<ConfigurationFactory> {
        return arrayOf(QueryProcessorConfigurationFactory(this, SPARQLQuery))
    }
}
