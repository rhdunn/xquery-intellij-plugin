...
declare type remote-port-type = (
    %a:since("exquery-request", "1.0-20130804") for xs:integer |
    %a:since("basex", "7.5") for xs:string
);

declare type header-names-type = (
    %a:since("exquery-request", "1.0-20130804") for xs:string+ |
    %a:since("basex", "7.5") for xs:string*
);

declare type cookie-type = (
    %a:since("exquery-request", "1.0-20130804") for xs:string? |
    %a:since("basex", "7.5") for xs:string*
);
...
declare %a:since("exquery-request", "1.0-20130804") %a:since("basex", "7.5") function request:cookie($name as xs:string) as cookie-type external;
...
declare %a:since("exquery-request", "1.0-20130804") %a:since("basex", "7.5") function request:header-names() as header-names-type external;
...
declare %a:since("exquery-request", "1.0-20130804") %a:since("basex", "7.5") function request:remote-port() as remote-port-type external;
