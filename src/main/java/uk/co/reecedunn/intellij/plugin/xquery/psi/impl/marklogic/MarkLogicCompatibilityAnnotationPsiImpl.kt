...
import uk.co.reecedunn.intellij.plugin.xquery.ast.marklogic.MarkLogicCompatibilityAnnotation
...
class MarkLogicCompatibilityAnnotationPsiImpl(node: ASTNode) : ASTWrapperPsiElement(node), MarkLogicCompatibilityAnnotation, XQueryConformanceCheck {
