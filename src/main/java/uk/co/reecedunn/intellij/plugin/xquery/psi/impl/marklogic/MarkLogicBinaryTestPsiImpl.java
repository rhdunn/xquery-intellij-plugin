...
public class MarkLogicBinaryTestPsiImpl extends ASTWrapperPsiElement implements MarkLogicBinaryTest, XQueryConformanceCheck {
    public MarkLogicBinaryTestPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
