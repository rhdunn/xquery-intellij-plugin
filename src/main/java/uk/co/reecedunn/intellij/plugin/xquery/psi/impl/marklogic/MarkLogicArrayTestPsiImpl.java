...
public class MarkLogicArrayTestPsiImpl extends ASTWrapperPsiElement implements MarkLogicArrayTest, XQueryConformanceCheck {
    public MarkLogicArrayTestPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
