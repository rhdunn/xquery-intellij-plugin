...
public class MarkLogicStylesheetImportPsiImpl extends ASTWrapperPsiElement implements MarkLogicStylesheetImport, XQueryConformanceCheck {
    public MarkLogicStylesheetImportPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
