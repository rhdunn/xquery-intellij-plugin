...
public class XQueryGroupingSpecListPsiImpl extends ASTWrapperPsiElement implements XQueryGroupingSpecList, XQueryVariableResolver {
    public XQueryGroupingSpecListPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
