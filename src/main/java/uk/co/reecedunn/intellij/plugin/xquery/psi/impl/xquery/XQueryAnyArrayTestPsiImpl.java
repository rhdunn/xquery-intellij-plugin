...
import uk.co.reecedunn.intellij.plugin.xquery.ast.xquery.XQueryAnyArrayTest;
...
public class XQueryAnyArrayTestPsiImpl extends ASTWrapperPsiElement implements XQueryAnyArrayTest, XQueryConformanceCheck {
    public XQueryAnyArrayTestPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
