...
import uk.co.reecedunn.intellij.plugin.xquery.ast.marklogic.MarkLogicSchemaComponentTest
...
class MarkLogicSchemaComponentTestPsiImpl(node: ASTNode) : ASTWrapperPsiElement(node), MarkLogicSchemaComponentTest, XQueryConformanceCheck {
