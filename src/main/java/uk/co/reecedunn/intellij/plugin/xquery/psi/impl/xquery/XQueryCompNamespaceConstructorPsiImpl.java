...
public class XQueryCompNamespaceConstructorPsiImpl extends ASTWrapperPsiElement implements XQueryCompNamespaceConstructor, XQueryConformanceCheck {
    public XQueryCompNamespaceConstructorPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
