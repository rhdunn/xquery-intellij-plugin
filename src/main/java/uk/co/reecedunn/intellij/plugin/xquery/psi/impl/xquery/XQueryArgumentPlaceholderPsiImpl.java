...
import uk.co.reecedunn.intellij.plugin.xquery.ast.xquery.XQueryArgumentPlaceholder;
...
public class XQueryArgumentPlaceholderPsiImpl extends ASTWrapperPsiElement implements XQueryArgumentPlaceholder, XQueryConformanceCheck {
    public XQueryArgumentPlaceholderPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
