...
public class XQueryAllowingEmptyPsiImpl extends ASTWrapperPsiElement implements XQueryAllowingEmpty, XQueryConformanceCheck {
    public XQueryAllowingEmptyPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
