...
public class XQueryInlineFunctionExprPsiImpl extends ASTWrapperPsiElement implements XQueryInlineFunctionExpr, XQueryConformanceCheck {
    public XQueryInlineFunctionExprPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
