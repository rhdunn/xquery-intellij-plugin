...
import uk.co.reecedunn.intellij.plugin.xquery.ast.xquery.XQueryUnaryLookup;
...
public class XQueryUnaryLookupPsiImpl extends ASTWrapperPsiElement implements XQueryUnaryLookup, XQueryConformanceCheck {
    public XQueryUnaryLookupPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
