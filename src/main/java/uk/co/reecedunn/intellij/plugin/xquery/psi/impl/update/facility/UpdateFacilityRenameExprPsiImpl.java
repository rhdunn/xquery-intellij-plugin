...
public class UpdateFacilityRenameExprPsiImpl extends ASTWrapperPsiElement implements UpdateFacilityRenameExpr, XQueryVersionedConstruct {
    public UpdateFacilityRenameExprPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
    ...
    public PsiElement getConformanceElement(XQueryConformance type) {
        if (type == XQueryConformance.UPDATE_FACILITY) {
            final ASTNode node = getNode().findChildByType(XQueryTokenType.K_RENAME);
