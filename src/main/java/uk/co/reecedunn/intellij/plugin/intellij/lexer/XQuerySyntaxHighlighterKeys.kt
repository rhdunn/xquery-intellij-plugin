...
internal object XQuerySyntaxHighlighterKeys {
    ...
    val KEYS = mapOf(
        ...
        XPathTokenType.STRING_LITERAL_START to XQuerySyntaxHighlighterKeys.STRING_KEYS,
        XPathTokenType.STRING_LITERAL_CONTENTS to XQuerySyntaxHighlighterKeys.STRING_KEYS,
        XPathTokenType.STRING_LITERAL_END to XQuerySyntaxHighlighterKeys.STRING_KEYS,
        XQueryTokenType.STRING_CONSTRUCTOR_START to XQuerySyntaxHighlighterKeys.STRING_KEYS,
        XQueryTokenType.STRING_CONSTRUCTOR_CONTENTS to XQuerySyntaxHighlighterKeys.STRING_KEYS,
        XQueryTokenType.STRING_CONSTRUCTOR_END to XQuerySyntaxHighlighterKeys.STRING_KEYS,
        XPathTokenType.BRACED_URI_LITERAL_START to XQuerySyntaxHighlighterKeys.STRING_KEYS,
        XPathTokenType.BRACED_URI_LITERAL_END to XQuerySyntaxHighlighterKeys.STRING_KEYS,
        ...
        XPathTokenType.BAD_CHARACTER to XQuerySyntaxHighlighterKeys.BAD_CHARACTER_KEYS,
        XPathTokenType.NCNAME to XQuerySyntaxHighlighterKeys.IDENTIFIER_KEYS,
        XPathTokenType.COMMENT_START_TAG to XQuerySyntaxHighlighterKeys.COMMENT_KEYS,
        XPathTokenType.COMMENT to XQuerySyntaxHighlighterKeys.COMMENT_KEYS,
        XPathTokenType.COMMENT_END_TAG to XQuerySyntaxHighlighterKeys.COMMENT_KEYS,
        XQueryTokenType.XML_COMMENT_END_TAG to XQuerySyntaxHighlighterKeys.COMMENT_KEYS,
        XQueryTokenType.XML_COMMENT to XQuerySyntaxHighlighterKeys.COMMENT_KEYS,
        XQueryTokenType.XML_COMMENT_START_TAG to XQuerySyntaxHighlighterKeys.COMMENT_KEYS,
        XQDocTokenType.XQDOC_COMMENT_MARKER to XQuerySyntaxHighlighterKeys.COMMENT_KEYS,
        XQDocTokenType.CONTENTS to XQuerySyntaxHighlighterKeys.COMMENT_KEYS,
        XQDocTokenType.TRIM to XQuerySyntaxHighlighterKeys.COMMENT_KEYS,
        XQDocTokenType.XML_ELEMENT_CONTENTS to XQuerySyntaxHighlighterKeys.COMMENT_KEYS,
