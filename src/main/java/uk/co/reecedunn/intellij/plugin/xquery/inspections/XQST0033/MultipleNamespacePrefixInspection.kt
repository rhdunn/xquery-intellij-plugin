 ...
 */
package uk.co.reecedunn.intellij.plugin.xquery.inspections.XQST0033
    ...
    override fun checkFile(file: PsiFile, manager: InspectionManager, isOnTheFly: Boolean): Array<ProblemDescriptor>? {
        ...
        file.children().filterIsInstance<XQueryModule>().forEach { module ->
            ...
            prolog?.children()?.forEach(fun (child) {
                ...
                if (duplicate != null) {
                    val description = XQueryBundle.message("inspection.XQST0033.multiple-namespace-prefix.message", prefix)
