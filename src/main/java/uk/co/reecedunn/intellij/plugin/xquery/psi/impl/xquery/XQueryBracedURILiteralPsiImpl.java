...
public class XQueryBracedURILiteralPsiImpl extends ASTWrapperPsiElement implements XQueryBracedURILiteral, XQueryConformanceCheck {
    public XQueryBracedURILiteralPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
