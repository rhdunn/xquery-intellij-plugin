...
import uk.co.reecedunn.intellij.plugin.xquery.ast.xquery.XQuerySquareArrayConstructor;
...
public class XQuerySquareArrayConstructorPsiImpl extends ASTWrapperPsiElement implements XQuerySquareArrayConstructor, XQueryConformanceCheck {
    public XQuerySquareArrayConstructorPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
