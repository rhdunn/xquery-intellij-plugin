...
import uk.co.reecedunn.intellij.plugin.xquery.ast.marklogic.MarkLogicAttributeDeclTest
...
class MarkLogicAttributeDeclTestPsiImpl(node: ASTNode) : ASTWrapperPsiElement(node), MarkLogicAttributeDeclTest, XQueryConformanceCheck {
