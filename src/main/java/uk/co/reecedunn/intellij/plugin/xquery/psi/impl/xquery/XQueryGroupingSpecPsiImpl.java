...
public class XQueryGroupingSpecPsiImpl extends ASTWrapperPsiElement implements XQueryGroupingSpec, XQueryVariableResolver {
    public XQueryGroupingSpecPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
