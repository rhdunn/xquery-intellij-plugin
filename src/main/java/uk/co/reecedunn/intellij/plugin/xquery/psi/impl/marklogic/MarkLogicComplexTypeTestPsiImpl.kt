...
import uk.co.reecedunn.intellij.plugin.xquery.ast.marklogic.MarkLogicComplexTypeTest
...
class MarkLogicComplexTypeTestPsiImpl(node: ASTNode) : ASTWrapperPsiElement(node), MarkLogicComplexTypeTest, XQueryConformanceCheck {
