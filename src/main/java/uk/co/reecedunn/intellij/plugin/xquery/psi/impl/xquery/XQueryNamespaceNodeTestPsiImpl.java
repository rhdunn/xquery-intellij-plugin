...
import uk.co.reecedunn.intellij.plugin.xquery.ast.xquery.XQueryNamespaceNodeTest;
...
public class XQueryNamespaceNodeTestPsiImpl extends ASTWrapperPsiElement implements XQueryNamespaceNodeTest, XQueryConformanceCheck {
    public XQueryNamespaceNodeTestPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
