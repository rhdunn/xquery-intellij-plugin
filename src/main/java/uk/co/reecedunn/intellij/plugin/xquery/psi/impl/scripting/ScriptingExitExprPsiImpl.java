...
public class ScriptingExitExprPsiImpl extends ASTWrapperPsiElement implements ScriptingExitExpr, XQueryConformanceCheck {
    public ScriptingExitExprPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
