...
public class XQueryAnyMapTestPsiImpl extends ASTWrapperPsiElement implements XQueryAnyMapTest, XQueryConformanceCheck {
    public XQueryAnyMapTestPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
