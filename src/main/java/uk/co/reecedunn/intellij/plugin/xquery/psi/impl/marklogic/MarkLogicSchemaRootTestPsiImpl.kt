...
import uk.co.reecedunn.intellij.plugin.xquery.ast.marklogic.MarkLogicSchemaRootTest
...
class MarkLogicSchemaRootTestPsiImpl(node: ASTNode) : ASTWrapperPsiElement(node), MarkLogicSchemaRootTest, XQueryConformanceCheck {
