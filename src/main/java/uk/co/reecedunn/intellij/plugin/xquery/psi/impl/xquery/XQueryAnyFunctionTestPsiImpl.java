...
public class XQueryAnyFunctionTestPsiImpl extends ASTWrapperPsiElement implements XQueryAnyFunctionTest, XQueryConformanceCheck {
    public XQueryAnyFunctionTestPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
