...
public class XQueryParserDefinition implements ParserDefinition {
    ...
    public PsiElement createElement(ASTNode node) {
        ...
        if (type == XQueryElementType.STRING_LITERAL) {
            ...
            return new XQueryAxisStepPsiImpl(node);
        } else if (type == XQueryElementType.FORWARD_STEP) {
            return new XQueryForwardStepPsiImpl(node);
        } else if (type == XQueryElementType.ABBREV_FORWARD_STEP) {
            return new XQueryAbbrevForwardStepPsiImpl(node);
        } else if (type == XQueryElementType.REVERSE_STEP) {
            return new XQueryReverseStepPsiImpl(node);
            ...
            return new XQueryNodeTestPsiImpl(node);
        } else if (type == XQueryElementType.NAME_TEST) {
            return new XQueryNameTestPsiImpl(node);
            ...
            return new XQueryPredicateListPsiImpl(node);
        } else if (type == XQueryElementType.PREDICATE) {
            return new XQueryPredicatePsiImpl(node);
            ...
            return new XQueryCompElemConstructorPsiImpl(node);
        } else if (type == XQueryElementType.COMP_ATTR_CONSTRUCTOR) {
            return new XQueryCompAttrConstructorPsiImpl(node);
            ...
            return new XQueryCompPIConstructorPsiImpl(node);
            ...
            return new XQueryContentExprPsiImpl(node);
