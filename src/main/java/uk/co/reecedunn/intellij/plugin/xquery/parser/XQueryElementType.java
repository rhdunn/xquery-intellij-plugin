...
public interface XQueryElementType {
    ...
    IElementType COMP_BINARY_CONSTRUCTOR = new ICompositeElementType("XQUERY_COMP_BINARY_CONSTRUCTOR", MarkLogicCompBinaryConstructorImpl.class, MarkLogicCompBinaryConstructorPsiImpl.class);
    IElementType BINARY_TEST = new ICompositeElementType("XQUERY_BINARY_TEST", MarkLogicBinaryTestImpl.class, MarkLogicBinaryTestPsiImpl.class);

    // endregion
    // region MarkLogic 8.0

    IElementType COMP_ARRAY_CONSTRUCTOR = new ICompositeElementType("XQUERY_COMP_ARRAY_CONSTRUCTOR", MarkLogicCompArrayConstructorImpl.class, MarkLogicCompArrayConstructorPsiImpl.class);
    ...
    IElementType COMP_OBJECT_CONSTRUCTOR = new ICompositeElementType("XQUERY_COMP_OBJECT_CONSTRUCTOR", MarkLogicCompObjectConstructorImpl.class, MarkLogicCompObjectConstructorPsiImpl.class);
    IElementType OBJECT_KEY_VALUE = new ICompositeElementType("XQUERY_OBJECT_KEY_VALUE", MarkLogicObjectKeyValueImpl.class, MarkLogicObjectKeyValuePsiImpl.class);
    IElementType OBJECT_TEST = new ICompositeElementType("XQUERY_OBJECT_TEST", MarkLogicObjectTestImpl.class, MarkLogicObjectTestPsiImpl.class);
