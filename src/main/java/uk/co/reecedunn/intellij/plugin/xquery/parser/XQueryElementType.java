...
public interface XQueryElementType {
    ...
    IElementType REVERSE_STEP = new ICompositeElementType("XQUERY_REVERSE_STEP", XPathReverseStepPsiImpl.class, XQuery.INSTANCE);
    IElementType REVERSE_AXIS = new ICompositeElementType("XQUERY_REVERSE_AXIS", XPathReverseAxisPsiImpl.class, XQuery.INSTANCE);
    IElementType ABBREV_REVERSE_STEP = new ICompositeElementType("XQUERY_ABBREV_REVERSE_STEP", XPathAbbrevReverseStepPsiImpl.class, XQuery.INSTANCE);
    ...
    IElementType WILDCARD = new ICompositeElementType("XQUERY_WILDCARD", XPathWildcardPsiImpl.class, XQuery.INSTANCE);
    ...
    IElementType RELATIVE_PATH_EXPR = new ICompositeElementType("XQUERY_RELATIVE_PATH_EXPR", XPathRelativePathExprPsiImpl.class, XQuery.INSTANCE);
    IElementType PATH_EXPR = new ICompositeElementType("XQUERY_PATH_EXPR", XPathPathExprPsiImpl.class, XQuery.INSTANCE);
    ...
    IElementType SINGLE_TYPE = new ICompositeElementType("XQUERY_SINGLE_TYPE", XPathSingleTypePsiImpl.class, XQuery.INSTANCE);
    IElementType UNARY_EXPR = new ICompositeElementType("XQUERY_UNARY_EXPR", XPathUnaryExprPsiImpl.class, XQuery.INSTANCE);
    ...
    IElementType UNION_EXPR = new ICompositeElementType("XQUERY_UNION_EXPR", XPathUnionExprPsiImpl.class, XQuery.INSTANCE);
    ...
    IElementType DEFAULT_CASE_CLAUSE = new ICompositeElementType("XQUERY_DEFAULT_CASE_CLAUSE", XQueryDefaultCaseClausePsiImpl.class, XQuery.INSTANCE);
    ...
    IElementType EXPR = new ICompositeElementType("XQUERY_EXPR", XPathExprPsiImpl.class, XQuery.INSTANCE);
    IElementType ENCLOSED_EXPR = new ICompositeElementType("XQUERY_ENCLOSED_EXPR", XPathEnclosedExprPsiImpl.class, XQuery.INSTANCE);
    ...
    IElementType ATTRIB_NAME_OR_WILDCARD = new ICompositeElementType("XQUERY_ATTRIB_NAME_OR_WILDCARD", XPathAttribNameOrWildcardPsiImpl.class, XQuery.INSTANCE);
    ...
    IElementType ELEMENT_TEST = new ICompositeElementType("XQUERY_ELEMENT_TEST", XPathElementTestPsiImpl.class, XQuery.INSTANCE);
    IElementType SCHEMA_ELEMENT_TEST = new ICompositeElementType("XQUERY_SCHEMA_ELEMENT_TEST", XPathSchemaElementTestPsiImpl.class, XQuery.INSTANCE);
    ...
    IElementType SCHEMA_ATTRIBUTE_TEST = new ICompositeElementType("XQUERY_SCHEMA_ATTRIBUTE_TEST", XPathSchemaAttributeTestPsiImpl.class, XQuery.INSTANCE);
    IElementType PI_TEST = new ICompositeElementType("XQUERY_PI_TEST", XPathPITestPsiImpl.class, XQuery.INSTANCE);
    IElementType COMMENT_TEST = new ICompositeElementType("XQUERY_COMMENT_TEST", XPathCommentTestPsiImpl.class, XQuery.INSTANCE);
    IElementType TEXT_TEST = new ICompositeElementType("XQUERY_TEXT_TEST", XPathTextTestPsiImpl.class, XQuery.INSTANCE);
    ...
    IElementType TYPE_DECLARATION = new ICompositeElementType("XQUERY_TYPE_DECLARATION", XPathTypeDeclarationPsiImpl.class, XQuery.INSTANCE);
    ...
    IElementType TYPED_FUNCTION_TEST = new ICompositeElementType("XQUERY_TYPED_FUNCTION_TEST", XPathTypedFunctionTestPsiImpl.class, XQuery.INSTANCE);
    IElementType PARENTHESIZED_ITEM_TYPE = new ICompositeElementType("XQUERY_PARENTHESIZED_ITEM_TYPE", XPathParenthesizedItemTypePsiImpl.class, XQuery.INSTANCE);
    ...
    IElementType NAMED_FUNCTION_REF = new ICompositeElementType("XQUERY_NAMED_FUNCTION_REF", XPathNamedFunctionRefPsiImpl.class, XQuery.INSTANCE);
    ...
    IElementType ARROW_FUNCTION_SPECIFIER = new ICompositeElementType("XQUERY_ARROW_FUNCTION_SPECIFIER", XPathArrowFunctionSpecifierPsiImpl.class, XQuery.INSTANCE);
    ...
    IElementType SQUARE_ARRAY_CONSTRUCTOR = new ICompositeElementType("XQUERY_SQUARE_ARRAY_CONSTRUCTOR", XPathSquareArrayConstructorPsiImpl.class, XQuery.INSTANCE);
    ...
    IElementType TYPED_MAP_TEST = new ICompositeElementType("XQUERY_TYPED_MAP_TEST", XPathTypedMapTestPsiImpl.class, XQuery.INSTANCE);
