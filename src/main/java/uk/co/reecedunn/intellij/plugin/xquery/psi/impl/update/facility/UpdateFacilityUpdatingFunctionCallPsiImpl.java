...
public class UpdateFacilityUpdatingFunctionCallPsiImpl extends ASTWrapperPsiElement implements UpdateFacilityUpdatingFunctionCall, XQueryConformanceCheck {
    public UpdateFacilityUpdatingFunctionCallPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
