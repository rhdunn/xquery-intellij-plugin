...
public class MarkLogicTransactionSeparatorPsiImpl extends ASTWrapperPsiElement implements MarkLogicTransactionSeparator, XQueryConformanceCheck {
    public MarkLogicTransactionSeparatorPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
