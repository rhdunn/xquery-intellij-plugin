...
public class XQueryASTFactory extends ASTFactory {
    ...
    public CompositeElement createComposite(final IElementType type) {
        if (type == XQueryElementType.STRING_LITERAL) {
            ...
            return new XQueryOrderedExprImpl(type);
        } else if (type == XQueryElementType.CONTEXT_ITEM_EXPR) {
            return new XQueryContextItemExprImpl(type);
        } else if (type == XQueryElementType.PARENTHESIZED_EXPR) {
            return new XQueryParenthesizedExprImpl(type);
        ...
        } else if (type == XQueryElementType.NODE_TEST) {
            return new XQueryNodeTestImpl(type);
            ...
            return new XQueryPredicateListImpl(type);
            ...
            return new XQueryTypeNameImpl(type);
        } else if (type == XQueryElementType.ELEMENT_DECLARATION) {
            return new XQueryElementDeclarationImpl(type);
        } else if (type == XQueryElementType.ELEMENT_NAME) {
            return new XQueryElementNameImpl(type);
        } else if (type == XQueryElementType.ELEMENT_NAME_OR_WILDCARD) {
            return new XQueryElementNameOrWildcardImpl(type);
            ...
            return new XQueryDirElemConstructorImpl(type);
        } else if (type == XQueryElementType.DIR_ELEM_CONTENT) {
            return new XQueryDirElemContentImpl(type);
        } else if (type == XQueryElementType.DIR_ATTRIBUTE_LIST) {
            return new XQueryDirAttributeListImpl(type);
            ...
            return new XQueryCompDocConstructorImpl(type);
        } else if (type == XQueryElementType.COMP_ELEM_CONSTRUCTOR) {
            return new XQueryCompElemConstructorImpl(type);
        } else if (type == XQueryElementType.COMP_ATTR_CONSTRUCTOR) {
            return new XQueryCompAttrConstructorImpl(type);
            ...
            return new XQueryContentExprImpl(type);
            ...
            return new XQueryElementTestImpl(type);
            ...
            return new XQueryTextTestImpl(type);
        } else if (type == XQueryElementType.DOCUMENT_TEST) {
            return new XQueryDocumentTestImpl(type);
            ...
            return new XQueryParamImpl(type);
        } else if (type == XQueryElementType.PARAM_LIST) {
            return new XQueryParamListImpl(type);
