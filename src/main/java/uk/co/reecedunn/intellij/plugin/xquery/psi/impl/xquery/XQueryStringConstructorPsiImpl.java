...
import uk.co.reecedunn.intellij.plugin.xquery.ast.xquery.XQueryStringConstructor;
...
public class XQueryStringConstructorPsiImpl extends ASTWrapperPsiElement implements XQueryStringConstructor, XQueryConformanceCheck {
    public XQueryStringConstructorPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
