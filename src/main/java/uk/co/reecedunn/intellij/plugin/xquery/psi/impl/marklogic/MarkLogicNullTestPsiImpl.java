...
public class MarkLogicNullTestPsiImpl extends ASTWrapperPsiElement implements MarkLogicNullTest, XQueryConformanceCheck {
    public MarkLogicNullTestPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
