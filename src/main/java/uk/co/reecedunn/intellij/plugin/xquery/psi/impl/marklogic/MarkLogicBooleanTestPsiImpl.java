...
import uk.co.reecedunn.intellij.plugin.xquery.ast.marklogic.MarkLogicBooleanTest;
...
public class MarkLogicBooleanTestPsiImpl extends ASTWrapperPsiElement implements MarkLogicBooleanTest, XQueryConformanceCheck {
    public MarkLogicBooleanTestPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
