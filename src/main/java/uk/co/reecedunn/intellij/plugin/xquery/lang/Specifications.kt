...
object XQuery : Language("XQuery", "application/xquery"), Versioned {
    ...
    val REC_1_0_20070123 =
        Specification("1.0-20070123", 1.0, 20070123, "1.0", "https://www.w3.org/TR/2007/REC-xquery-20070123/", this)

    val REC_1_0_20101214 =
        Specification("1.0-20101214", 1.0, 20101214, "1.0", "https://www.w3.org/TR/2010/REC-xquery-20101214/", this)

    // endregion
    // region 3.0

    val REC_3_0_20140408 =
        Specification("3.0-20140408", 3.0, 20140408, "3.0", "https://www.w3.org/TR/2014/REC-xquery-30-20140408/", this)

    // endregion
    // region 3.1

    val CR_3_1_20151217 =
        Specification("3.1-20151217", 3.1, 20151217, "3.1", "https://www.w3.org/TR/2015/CR-xquery-31-20151217/", this)

    val REC_3_1_20170321 =
        Specification("3.1-20170321", 3.1, 20170321, "3.1", "https://www.w3.org/TR/2017/REC-xquery-31-20170321/", this)
    ...
    val MARKLOGIC_0_9 = Specification(
        ...
        2007,
        "0.9-ml",
        "http://docs.marklogic.com/guide/xquery/dialects#id_65735",
        this
    ...
    val MARKLOGIC_1_0 = Specification(
        ...
        2008,
        "1.0-ml",
        "http://docs.marklogic.com/guide/xquery/dialects#id_63368",
        this
    ) // MarkLogic 4.0+
...
object FullText : Versioned {
    ...
    override fun supportsDialect(dialect: Versioned): Boolean = dialect === this || dialect === XQuery
}
...
object Scripting : Versioned {
    val NOTE_1_0_20140918 = Specification(
        ...
        20140918,
        "1.0",
        "https://www.w3.org/TR/2014/NOTE-xquery-sx-10-20140918/",
        this
    )
