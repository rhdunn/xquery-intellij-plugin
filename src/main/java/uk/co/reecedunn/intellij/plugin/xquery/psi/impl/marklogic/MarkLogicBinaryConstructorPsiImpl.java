...
import uk.co.reecedunn.intellij.plugin.xquery.ast.marklogic.MarkLogicBinaryConstructor;
...
public class MarkLogicBinaryConstructorPsiImpl extends ASTWrapperPsiElement implements MarkLogicBinaryConstructor, XQueryConformanceCheck {
    public MarkLogicBinaryConstructorPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
