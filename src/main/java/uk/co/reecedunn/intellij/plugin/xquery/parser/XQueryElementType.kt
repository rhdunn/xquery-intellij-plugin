...
object XQueryElementType {
    ...
    val COMPLEX_TYPE_TEST: IElementType = ICompositeElementType("XQUERY_COMPLEX_TYPE_TEST", PluginComplexTypeTestPsiImpl::class.java, XQuery)
    val ELEMENT_DECL_TEST: IElementType = ICompositeElementType("XQUERY_ELEMENT_DECL_TEST", PluginElementDeclTestPsiImpl::class.java, XQuery)
    ...
    val SIMPLE_TYPE_TEST: IElementType = ICompositeElementType("XQUERY_SIMPLE_TYPE_TEST", PluginSimpleTypeTestPsiImpl::class.java, XQuery)
    ...
    val ANY_ARRAY_NODE_TEST: IElementType = ICompositeElementType("XQUERY_ANY_ARRAY_NODE_TEST", PluginAnyArrayNodeTestPsiImpl::class.java, XQuery)
    val NAMED_ARRAY_NODE_TEST: IElementType = ICompositeElementType("XQUERY_NAMED_ARRAY_NODE_TEST", PluginNamedArrayNodeTestPsiImpl::class.java, XQuery)
    ...
    val NULL_CONSTRUCTOR: IElementType = ICompositeElementType("XQUERY_NULL_CONSTRUCTOR", PluginNullConstructorPsiImpl::class.java, XQuery)
    val ANY_NULL_NODE_TEST: IElementType = ICompositeElementType("XQUERY_ANY_NULL_NODE_TEST", PluginAnyNullNodeTestPsiImpl::class.java, XQuery)
    val NAMED_NULL_NODE_TEST: IElementType = ICompositeElementType("XQUERY_NAMED_NULL_NODE_TEST", PluginNamedNullNodeTestPsiImpl::class.java, XQuery)
    ...
    val QUANTIFIED_EXPR_BINDING: IElementType = ICompositeElementType("XQUERY_QUANTIFIED_EXPR_BINDING", PluginQuantifiedExprBindingPsiImpl::class.java, XQuery)
