...
import uk.co.reecedunn.intellij.plugin.xpath.psi.impl.plugin.PluginElvisExprPsiImpl
...
object XQueryElementType {
    ...
    val STRING_CONSTRUCTOR_INTERPOLATION: IElementType =
    ...
    val NON_DETERMINISTIC_FUNCTION_CALL: IElementType =
        ICompositeElementType(
