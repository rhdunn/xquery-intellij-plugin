...
import uk.co.reecedunn.intellij.plugin.xquery.ast.plugin.PluginItemTypeUnion
import uk.co.reecedunn.intellij.plugin.xquery.lexer.XQueryTokenType
import uk.co.reecedunn.intellij.plugin.xquery.psi.XQueryConformance

class PluginItemTypeUnionPsiImpl(node: ASTNode) :
    ASTWrapperPsiElement(node), PluginItemTypeUnion, XQueryConformance {
