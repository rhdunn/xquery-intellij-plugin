...
import uk.co.reecedunn.intellij.plugin.xquery.ast.marklogic.MarkLogicSimpleTypeTest
...
class MarkLogicSimpleTypeTestPsiImpl(node: ASTNode) : ASTWrapperPsiElement(node), MarkLogicSimpleTypeTest, XQueryConformanceCheck {
