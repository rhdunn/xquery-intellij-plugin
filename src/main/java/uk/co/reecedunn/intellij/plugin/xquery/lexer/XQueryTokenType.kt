...
object XQueryTokenType {
    ...
    val NCNAME: IElementType = INCNameType("XQUERY_NCNAME_TOKEN", XQuery)
    ...
    val K_CASTABLE = IKeywordOrNCNameType("XQUERY_KEYWORD_OR_NCNAME_CASTABLE", XQuery)
    ...
    val K_DIV = IKeywordOrNCNameType("XQUERY_KEYWORD_OR_NCNAME_DIV", XQuery)
    ...
    val K_MOD = IKeywordOrNCNameType("XQUERY_KEYWORD_OR_NCNAME_MOD", XQuery)
