...
object XQueryTokenType {
    ...
    val PRAGMA_CONTENTS = IElementType("XQUERY_PRAGMA_CONTENTS_TOKEN", XQuery) // XQuery 1.0
    val PRAGMA_BEGIN = IElementType("XQUERY_PRAGMA_BEGIN_TOKEN", XQuery) // XQuery 1.0
    val PRAGMA_END = IElementType("XQUERY_PRAGMA_END_TOKEN", XQuery) // XQuery 1.0
    ...
    val K_DEFAULT = IKeywordOrNCNameType("XQUERY_KEYWORD_OR_NCNAME_DEFAULT", XQuery) // XQuery 1.0
    ...
    val K_LEAST = IKeywordOrNCNameType("XQUERY_KEYWORD_OR_NCNAME_LEAST", XQuery) // XQuery 1.0
    ...
    val K_NO_INHERIT = IKeywordOrNCNameType("XQUERY_KEYWORD_OR_NCNAME_NO_INHERIT", XQuery) // XQuery 1.0
    val K_NO_PRESERVE = IKeywordOrNCNameType("XQUERY_KEYWORD_OR_NCNAME_NO_PRESERVE", XQuery) // XQuery 1.0
    ...
    val K_OPTION = IKeywordOrNCNameType("XQUERY_KEYWORD_OR_NCNAME_OPTION", XQuery) // XQuery 1.0
