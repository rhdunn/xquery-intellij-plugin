...
public class XQueryWindowClausePsiImpl extends ASTWrapperPsiElement implements XQueryWindowClause, XQueryVariableResolver {
    public XQueryWindowClausePsiImpl(@NotNull ASTNode node) {
        super(node);
    }
