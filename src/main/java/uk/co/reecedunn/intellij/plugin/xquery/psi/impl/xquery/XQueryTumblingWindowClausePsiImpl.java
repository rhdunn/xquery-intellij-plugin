...
public class XQueryTumblingWindowClausePsiImpl extends ASTWrapperPsiElement implements XQueryTumblingWindowClause, XQueryConformanceCheck, XQueryVariableResolver {
    public XQueryTumblingWindowClausePsiImpl(@NotNull ASTNode node) {
        super(node);
    }
