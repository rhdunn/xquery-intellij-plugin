...
public class XQueryGroupingVariablePsiImpl extends ASTWrapperPsiElement implements XQueryGroupingVariable, XQueryVariableResolver {
    public XQueryGroupingVariablePsiImpl(@NotNull ASTNode node) {
        super(node);
    }
