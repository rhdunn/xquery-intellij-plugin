...
import uk.co.reecedunn.intellij.plugin.xquery.ast.marklogic.MarkLogicCompArrayConstructor;
...
public class MarkLogicCompArrayConstructorPsiImpl extends ASTWrapperPsiElement implements MarkLogicCompArrayConstructor, XQueryConformanceCheck {
    public MarkLogicCompArrayConstructorPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
