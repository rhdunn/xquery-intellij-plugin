...
public class ScriptingWhileExprPsiImpl extends XQueryExprPsiImpl implements ScriptingWhileExpr, XQueryConformanceCheck {
    public ScriptingWhileExprPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
