...
import uk.co.reecedunn.intellij.plugin.xquery.ast.xquery.XQueryParenthesizedItemType;
import uk.co.reecedunn.intellij.plugin.xquery.lang.*;
import uk.co.reecedunn.intellij.plugin.xquery.psi.XQueryConformanceCheck;
import uk.co.reecedunn.intellij.plugin.xquery.resources.XQueryBundle;

public class XQueryParenthesizedItemTypePsiImpl extends ASTWrapperPsiElement implements XQueryParenthesizedItemType, XQueryConformanceCheck {
    public XQueryParenthesizedItemTypePsiImpl(@NotNull ASTNode node) {
        super(node);
    }
