...
public class XQueryContextItemDeclPsiImpl extends ASTWrapperPsiElement implements XQueryContextItemDecl, XQueryConformanceCheck {
    public XQueryContextItemDeclPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
    ...
    public PsiElement getConformanceElement() {
        return findChildByType(XQueryTokenType.K_CONTEXT);
    }
