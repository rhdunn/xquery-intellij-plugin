...
import uk.co.reecedunn.intellij.plugin.xquery.ast.marklogic.MarkLogicCompObjectConstructor;
...
public class MarkLogicCompObjectConstructorPsiImpl extends ASTWrapperPsiElement implements MarkLogicCompObjectConstructor, XQueryConformanceCheck {
    public MarkLogicCompObjectConstructorPsiImpl(@NotNull ASTNode node) {
        super(node);
    }
