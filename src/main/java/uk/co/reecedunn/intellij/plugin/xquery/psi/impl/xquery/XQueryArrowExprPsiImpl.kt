...
class XQueryArrowExprPsiImpl(node: ASTNode) : ASTWrapperPsiElement(node), XQueryArrowExpr, XQueryConformanceCheck {
    override fun conformsTo(implementation: ImplementationItem): Boolean {
        ...
        return implementation.getVersion(XQuery).supportsVersion(XQueryVersion.VERSION_3_1) ||
               implementation.getVersion(MarkLogic).supportsVersion(XQueryVersion.VERSION_9_0)
    }
    ...
    override val conformanceErrorMessage get(): String =
        XQueryBundle.message("requires.feature.marklogic-9-xquery.version")
}
