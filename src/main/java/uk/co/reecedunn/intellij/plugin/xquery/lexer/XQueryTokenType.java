...
public interface XQueryTokenType extends TokenType {
    ...
    IXQueryReservedFunctionNameOrNCNameType K_ARRAY_NODE = new IXQueryReservedFunctionNameOrNCNameType("XQUERY_KEYWORD_OR_NCNAME_ARRAY_NODE"); // MarkLogic 8.0
    ...
    IXQueryReservedFunctionNameOrNCNameType K_BOOLEAN_NODE = new IXQueryReservedFunctionNameOrNCNameType("XQUERY_KEYWORD_OR_NCNAME_BOOLEAN_NODE"); // MarkLogic 8.0
    ...
    IXQueryReservedFunctionNameOrNCNameType K_NULL_NODE = new IXQueryReservedFunctionNameOrNCNameType("XQUERY_KEYWORD_OR_NCNAME_NULL_NODE"); // MarkLogic 8.0
    IXQueryReservedFunctionNameOrNCNameType K_NUMBER_NODE = new IXQueryReservedFunctionNameOrNCNameType("XQUERY_KEYWORD_OR_NCNAME_NUMBER_NODE"); // MarkLogic 8.0
    IXQueryReservedFunctionNameOrNCNameType K_OBJECT_NODE = new IXQueryReservedFunctionNameOrNCNameType("XQUERY_KEYWORD_OR_NCNAME_OBJECT_NODE"); // MarkLogic 8.0
