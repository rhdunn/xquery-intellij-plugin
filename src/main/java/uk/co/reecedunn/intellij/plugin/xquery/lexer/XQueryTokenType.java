...
public interface XQueryTokenType extends TokenType {
    ...
    IElementType DIRELEM_MAYBE_OPEN_XML_TAG = new IElementType("XQUERY_DIRELEM_MAYBE_OPEN_XML_TAG_TOKEN", XQuery.INSTANCE);
    IElementType DIRELEM_OPEN_XML_TAG = new IElementType("XQUERY_DIRELEM_OPEN_XML_TAG_TOKEN", XQuery.INSTANCE);
    ...
    IXQueryKeywordOrNCNameType K_FROM = new IXQueryKeywordOrNCNameType("XQUERY_KEYWORD_OR_NCNAME_FROM"); // Full Text 1.0
    ...
    IXQueryKeywordOrNCNameType K_FUZZY = new IXQueryKeywordOrNCNameType("XQUERY_KEYWORD_OR_NCNAME_FUZZY"); // BaseX 6.1
    ...
    IXQueryKeywordOrNCNameType K_MOST = new IXQueryKeywordOrNCNameType("XQUERY_KEYWORD_OR_NCNAME_MOST"); // Full Text 1.0
    ...
    IXQueryKeywordOrNCNameType K_NO = new IXQueryKeywordOrNCNameType("XQUERY_KEYWORD_OR_NCNAME_NO"); // Full Text 1.0
    ...
    IXQueryKeywordOrNCNameType K_SCHEMA_FACET = new IXQueryKeywordOrNCNameType("XQUERY_KEYWORD_OR_NCNAME_SCHEMA_FACET_NODE", IXQueryKeywordOrNCNameType.KeywordType.MARKLOGIC80_RESERVED_FUNCTION_NAME); // MarkLogic 8.0
