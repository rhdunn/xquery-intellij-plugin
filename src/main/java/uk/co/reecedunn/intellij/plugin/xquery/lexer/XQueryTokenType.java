...
public interface XQueryTokenType extends TokenType {
    ...
    IElementType XQDOC_TAG_CONTENTS_START = new IElementType("XQUERY_XQDOC_TAG_CONTENTS_START_TOKEN", XQuery.INSTANCE);

    IElementType XQDOC_OPEN_XML_TAG = new IElementType("XQUERY_XQDOC_OPEN_XML_TAG_TOKEN", XQuery.INSTANCE);
    IElementType XQDOC_END_XML_TAG = new IElementType("XQUERY_XQDOC_END_XML_TAG_TOKEN", XQuery.INSTANCE);
    IElementType XQDOC_CLOSE_XML_TAG = new IElementType("XQUERY_XQDOC_CLOSE_XML_TAG_TOKEN", XQuery.INSTANCE);
    IElementType XQDOC_SELF_CLOSING_XML_TAG = new IElementType("XQUERY_XQDOC_SELF_CLOSING_XML_TAG_TOKEN", XQuery.INSTANCE);

    IElementType XQDOC_XML_TAG_NAME = new IElementType("XQUERY_XQDOC_XML_TAG_NAME_TOKEN", XQuery.INSTANCE);
    IElementType XQDOC_XML_EQUAL = new IElementType("XQUERY_XQDOC_XML_EQUAL_TOKEN", XQuery.INSTANCE);
    IElementType XQDOC_XML_ATTRIBUTE_VALUE_START = new IElementType("XQUERY_XQDOC_XML_ATTRIBUTE_VALUE_START_TOKEN", XQuery.INSTANCE);
    IElementType XQDOC_XML_ATTRIBUTE_VALUE_CONTENTS = new IElementType("XQUERY_XQDOC_XML_ATTRIBUTE_VALUE_CONTENTS_TOKEN", XQuery.INSTANCE);
    IElementType XQDOC_XML_ATTRIBUTE_VALUE_END = new IElementType("XQUERY_XQDOC_XML_ATTRIBUTE_VALUE_END_TOKEN", XQuery.INSTANCE);
    IElementType XQDOC_XML_ELEM_CONTENTS = new IElementType("XQUERY_XQDOC_XML_ELEM_CONTENTS_TOKEN", XQuery.INSTANCE);
