...
public interface XQueryTokenType extends TokenType {
    ...
    IXQueryKeywordOrNCNameType K_ARRAY_NODE = new IXQueryKeywordOrNCNameType("XQUERY_KEYWORD_OR_NCNAME_ARRAY_NODE"); // MarkLogic 8.0
    ...
    IXQueryKeywordOrNCNameType K_BOOLEAN_NODE = new IXQueryKeywordOrNCNameType("XQUERY_KEYWORD_OR_NCNAME_BOOLEAN_NODE"); // MarkLogic 8.0
