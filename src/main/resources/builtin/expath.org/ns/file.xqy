...
declare type copy-write-result = (
    %a:since("expath-file", "1.0-20100517") for xs:boolean |
    %a:since("basex", "7.0") for empty-sequence()
);
...
declare %a:since("expath-file", "1.0-20100517") %a:since("basex", "7.0") function file:copy($source as xs:string, $destination as xs:string) as copy-write-result external;
declare %a:since("expath-file", "1.0-20100517") function file:copy($source as xs:string, $destination as xs:string, $overwrite as xs:boolean) as xs:boolean external;
declare %a:since("expath-file", "1.0-20100517") %a:since("basex", "7.0") function file:exists($path as xs:string) as xs:boolean external;
declare %a:since("expath-file", "1.0-20100517") function file:files($path as xs:string) as xs:string* external;
declare %a:since("expath-file", "1.0-20100517") function file:files($path as xs:string, $pattern as xs:string) as xs:string* external;
declare %a:since("expath-file", "1.0-20100517") function file:files($path as xs:string, $pattern as xs:string, $recursive as xs:boolean) as xs:string* external;
declare %a:since("expath-file", "1.0-20100517") %a:since("basex", "7.0") %a:until("basex", "7.3", "file:is-dir#1") function file:is-directory($path as xs:string) as xs:boolean external;
declare %a:since("expath-file", "1.0-20100517") %a:since("basex", "7.0") function file:is-file($path as xs:string) as xs:boolean external;
declare %a:since("expath-file", "1.0-20100517") %a:since("basex", "7.0") function file:last-modified($path as xs:string) as xs:dateTime external;
declare %a:since("expath-file", "1.0-20100517") function file:mkdir($dir as xs:string) as xs:boolean external;
declare %a:since("expath-file", "1.0-20100517") function file:mkdir($dir as xs:string, $create as xs:boolean) as xs:boolean external;
declare %a:since("expath-file", "1.0-20100517") function file:mkdirs($dir as xs:string) as xs:boolean external;
declare %a:since("expath-file", "1.0-20100517") function file:mkdirs($dir as xs:string, $create as xs:boolean) as xs:boolean external;
declare %a:since("expath-file", "1.0-20100517") %a:since("basex", "7.0") function file:path-separator() as xs:string external;
declare %a:since("expath-file", "1.0-20100517") function file:path-to-full-path($path as xs:string) as xs:string external;
declare %a:since("expath-file", "1.0-20100517") %a:since("basex", "7.0") function file:path-to-uri($path as xs:string) as path-uri-result external;
declare %a:since("expath-file", "1.0-20100517") function file:read($file as xs:string) as xs:base64Binary external;
declare %a:since("expath-file", "1.0-20100517") function file:read-html($file as xs:string, $tidyOptions as xs:string) as xs:string external;
declare %a:since("expath-file", "1.0-20100517") function file:read-text($file as xs:string) as xs:string external;
declare %a:since("expath-file", "1.0-20100517") function file:read-xml($file as xs:string) as node() external;
declare %a:since("expath-file", "1.0-20100517") function file:read-xml($file as xs:string, $tidy as xs:boolean) as node() external;
declare %a:since("expath-file", "1.0-20100517") function file:remove($path as xs:string) as xs:boolean external;
declare %a:since("expath-file", "1.0-20100517") %a:since("basex", "7.0") function file:write($file as xs:string, $content as item()*, $params as write-params) as copy-write-result external;
declare %a:since("expath-file", "1.0-20100517") function file:write($file as xs:string, $content as item()*, $params as node()*, $append as xs:boolean) as xs:boolean external;
