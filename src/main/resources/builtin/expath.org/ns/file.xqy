...
declare %a:since("expath-file", "1.0-20120614") %a:since("basex", "7.0") %a:until("basex", "7.8", "file:name#1") function file:base-name($path as xs:string) as xs:string external;
declare %a:since("expath-file", "1.0-20120614") %a:since("basex", "7.0") %a:until("basex", "7.8") function file:base-name($path as xs:string, $suffix as xs:string) as xs:string external;
...
declare %a:since("expath-file", "1.0-20120614") %a:since("basex", "7.0") %a:until("basex", "7.8", "file:parent#1") function file:dir-name($path as xs:string) as xs:string external;
