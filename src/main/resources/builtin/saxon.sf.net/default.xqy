...
declare %a:since("saxon/pe", "9.8") function saxon:array-member($value as item()*) as jt:com.saxonica.functions.extfn.ArrayMemberValue external; (: http://www.saxonica.com/html/documentation/functions/saxon/array-member.html? how to indicate namespaces there? :)
