...
declare %a:since("basex", "7.0") function db:list-details() as element(database)* external;
declare %a:since("basex", "7.0") function db:list-details($db as xs:string) as element(resource)* external;
declare %a:since("basex", "7.0") function db:list-details($db as xs:string, $path as xs:string) as element(resource)* external;
...
declare %a:since("basex", "7.0") function db:text-range($db as xs:string, $min as xs:string, $max as xs:string) as text()* external;
declare %a:since("basex", "7.0") function db:attribute($db as xs:string, $strings as as xs:string*) as attribute()* external;
...
declare %a:since("basex", "7.0") function db:attribute-range($db as xs:string, $min as xs:string, $max as xs:string) as attribute()* external;
...
declare %a:since("basex", "7.0") function db:create($db as xs:string) as empty-sequence() external;
declare %a:since("basex", "7.0") function db:create($db as xs:string, $inputs as item()*) as empty-sequence() external;
declare %a:since("basex", "7.0") function db:create($db as xs:string, $inputs as item()*, $paths as xs:string*) as empty-sequence() external;
declare %a:since("basex", "7.0") function db:create($db as xs:string, $inputs as item()*, $paths as xs:string*, $options as map(*)?) as empty-sequence() external;
declare %a:since("basex", "7.0") function db:drop($db as xs:string) as empty-sequence() external;
...
declare %a:since("basex", "7.0") function db:copy($db as xs:string, $name as xs:string) as empty-sequence() external;
declare %a:since("basex", "7.0") function db:alter($db as xs:string, $name as xs:string) as empty-sequence() external;
declare %a:since("basex", "7.0") function db:create-backup($db as xs:string) as empty-sequence() external;
declare %a:since("basex", "7.0") function db:drop-backup($name as xs:string) as empty-sequence() external;
declare %a:since("basex", "7.0") function db:restore($name as xs:string) as empty-sequence() external;
...
declare %a:since("basex", "7.0") function db:flush($db as xs:string) as empty-sequence() external;
declare %a:since("basex", "7.0") function db:name($node as node()) as xs:string external;
declare %a:since("basex", "7.0") function db:path($node as node()) as xs:string external;
...
declare %a:since("basex", "7.0") function db:content-type($db as xs:string, $path as xs:string) as xs:string external;