...
declare %a:since("marklogic", "7.0") function cts:reference-parse() as cts:reference external;
declare %a:since("marklogic", "7.0") function cts:reference-parse($reference as element()) as cts:reference external;
...
declare %a:since("marklogic", "6.0") function cts:valid-index-path($string as xs:string) as xs:boolean external;
