...
declare %a:since("marklogic", "8.0") function cts:element-attribute-value-geospatial-co-occurrences($element-name-1 as xs:QName, $attribute-name-1 as xs:QName?, $geo-element-name as xs:QName, $child-name-1 as xs:QName?) as element(cts:co-occurrence)* external;
...
declare %a:since("marklogic", "8.0") function cts:element-value-geospatial-co-occurrences($element-name-1 as xs:QName, $geo-element-name as xs:QName, $child-name-1 as xs:QName?) as element(cts:co-occurrence)* external;
...
declare %a:since("marklogic", "8.0") function cts:match-regions($range-indexes as cts:reference*, $operation as xs:string, $regions as cts:region+) as item()* external;
declare %a:since("marklogic", "8.0") function cts:match-regions($range-indexes as cts:reference*, $operation as xs:string, $regions as cts:region+, $options as xs:string*) as item()* external;
declare %a:since("marklogic", "8.0") function cts:match-regions($range-indexes as cts:reference*, $operation as xs:string, $regions as cts:region+, $options as xs:string*, $query as cts:query?) as item()* external;
declare %a:since("marklogic", "8.0") function cts:match-regions($range-indexes as cts:reference*, $operation as xs:string, $regions as cts:region+, $options as xs:string*, $query as cts:query?, $forest-ids as xs:unsignedLong*) as item()* external;
