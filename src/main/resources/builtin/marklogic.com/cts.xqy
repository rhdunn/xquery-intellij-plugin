...
declare %a:since("marklogic", "5.0") function cts:element-attribute-range-query-operator($query as cts:element-attribute-range-query) as xs:anyAtomicType* external;
...
declare %a:since("marklogic", "5.0") function cts:element-geospatial-query-region($query as cts:element-geospatial-query) as cts:box* external;
...
declare %a:since("marklogic", "5.0") function cts:element-range-query-operator($query as cts:element-range-query) as xs:anyAtomicType* external;
...
declare %a:since("marklogic", "5.0") function cts:field-range-query-field-name($query as cts:field-range-query) as xs:string external;
declare %a:since("marklogic", "5.0") function cts:field-range-query-operator($query as cts:field-range-query) as xs:anyAtomicType* external;
...
declare %a:since("marklogic", "5.0") function cts:near-query-queries($query as cts:near-query) as cts:query external;
