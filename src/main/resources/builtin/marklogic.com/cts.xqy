...
declare %a:since("marklogic", "8.0") function cts:doc($uri as xs:string) as document-node()? external;
...
declare %a:since("marklogic", "8.0") function cts:element-walk($node as node(), $element as xs:QName*, $callback as function(NodeBuilder, node()) as xs:string?, $builder as NodeBuilder) as empty-sequence() external;
...
declare %a:since("marklogic", "8.0") function cts:estimate($query as cts:query?) as xs:integer external;
declare %a:since("marklogic", "8.0") function cts:estimate($query as cts:query?, $options as (cts:order|xs:string)*) as xs:integer external;
...
declare %a:since("marklogic", "8.0") function cts:highlight($node as node(), $query as cts:query, $callback as function(NodeBuilder, xs:string, text(), cts:query*, xs:integer) as xs:string?, $builder as NodeBuilder) as empty-sequence() external;
...
declare %a:since("marklogic", "8.0") function cts:plan($query as cts:query?) as element() external;
declare %a:since("marklogic", "8.0") function cts:plan($query as cts:query?, $options as (cts:order|xs:string)*) as element() external;
declare %a:since("marklogic", "8.0") function cts:plan($query as cts:query?, $options as (cts:order|xs:string)*, $quality-weight as xs:double?) as element() external;
declare %a:since("marklogic", "8.0") function cts:plan($query as cts:query?, $options as (cts:order|xs:string)*, $quality-weight as xs:double?, $forest-ids as xs:unsignedLong*) as element() external;
declare %a:since("marklogic", "8.0") function cts:plan($query as cts:query?, $options as (cts:order|xs:string)*, $quality-weight as xs:double?, $forest-ids as xs:unsignedLong*, $maximum as xs:double?) as element() external;
...
declare %a:since("marklogic", "8.0") function cts:walk($node as node(), $query as cts:query, $callback as function(xs:string, text(), cts:query*, xs:integer) as xs:string?) as empty-sequence() external;
