...
declare %a:since("marklogic", "5.0") function dbg:eval($xquery as xs:string, $vars as item()*, $options as node()?) as xs:unsignedLong external;
...
declare %a:since("marklogic", "5.0") function dbg:invoke($uri as xs:string, $vars as item()*, $options as node()?) as xs:unsignedLong external;
declare %a:since("marklogic", "5.0") function dbg:line($request as xs:unsignedLong, $uri as xs:string, $line as xs:unsigned) as xs:unsignedLong* external;
