...
declare %a:since("marklogic", "7.0") function sc:facets() as element()* external;
declare %a:since("marklogic", "7.0") function sc:facets($arg as schema-component()) as element()* external;
declare %a:since("marklogic", "7.0") function sc:function-parameter-type($arg as function(*), $param as xs:integer) as schema-type()? external;
...
declare %a:since("marklogic", "7.0") function sc:schema-from-path($namespace as xs:string) as xs:string* external;
declare %a:since("marklogic", "7.0") function sc:schema-from-path($namespace as xs:string, $location as xs:string) as xs:string* external;
...
declare %a:since("marklogic", "7.0") function sc:type-apply($type as schema-type(), $arg as item()*) as item()* external;
declare %a:since("marklogic", "7.0") function sc:type-named() as schema-type()? external;
declare %a:since("marklogic", "7.0") function sc:type-named($arg as xs:QName) as schema-type()? external;