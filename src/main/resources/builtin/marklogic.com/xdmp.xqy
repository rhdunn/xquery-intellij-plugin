...
declare %a:since("marklogic", "7.0") function xdmp:database-partition-forests($value (: as [7.0]]item() [8.0]xs:anyAtomicType :)) (: as [7.0] xs:positiveInteger* [8.0]xs:unsignedLong* :) external;
...
declare %a:since("marklogic", "5.0") function xdmp:eval($xquery as xs:string, $vars as item()*, $options (: as [5.0]node()? [8.0](element()|map:map)? :)) as item()* external;
...
declare %a:since("marklogic", "5.0") function xdmp:invoke($path as xs:string, $vars as item()*, $options (: as [5.0]node()? [8.0](element()|map:map)? :)) as item()* external;
declare %a:since("marklogic", "7.0") function xdmp:invoke-function($func as function() as item()*) as item()* external;
declare %a:since("marklogic", "7.0") function xdmp:invoke-function($func as function() as item()*, $options (: as [5.0]node()? [8.0](element()|map:map)? :)) as item()* external;
...
declare %a:since("marklogic", "8.0") function xdmp:javascript-eval($javascript as xs:string, $vars as item()*) as item()* external;
declare %a:since("marklogic", "8.0") function xdmp:javascript-eval($javascript as xs:string, $vars as item()*, $options as node()?) as item()* external;
...
declare %a:since("marklogic", "5.0") function xdmp:spawn($path as xs:string, $vars as item()*, $options (: as [5.0]node()? [8.0](element()|map:map)? :)) as item()* external;
...
declare %a:since("marklogic", "8.0") function xdmp:unpath($expr as xs:string, $map as map:map) as item()* external;
...
declare %a:since("marklogic", "8.0") function xdmp:user-last-login() as element(last-login)? external;
...
declare %a:since("marklogic", "8.0") function xdmp:value($expr as xs:string, $map as map:map) as item()* external;
