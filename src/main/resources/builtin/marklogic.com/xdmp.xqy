...
declare %a:since("marklogic", "5.0") function xdmp:cache-status($host-id as xs:unsignedLong) as element(cache-status) external;
...
declare %a:since("marklogic", "5.0") function xdmp:database-forests($database as xs:unsignedLong) as xs:unsignedLong* external;
declare %a:since("marklogic", "5.0") function xdmp:database-forests($database as xs:unsignedLong, $include-replicas as xs:boolean?) as xs:unsignedLong* external;
declare %a:since("marklogic", "5.0") function xdmp:database-global-nonblocking-timestamp($id as xs:unsignedLong) as xs:unsignedLong external;
declare %a:since("marklogic", "5.0") function xdmp:database-is-replica($id as xs:unsignedLong) as xs:boolean external;
declare %a:since("marklogic", "5.0") function xdmp:database-name($database-id as xs:unsignedLong) as xs:string external;
declare %a:since("marklogic", "5.0") function xdmp:database-nonblocking-timestamp($id as xs:unsignedLong) as xs:unsignedLong external;
...
declare %a:since("marklogic", "5.0") function xdmp:default-collections() as element()* external;
declare %a:since("marklogic", "5.0") function xdmp:default-collections($uri as xs:string) as element()* external;
...
declare %a:since("marklogic", "5.0") function xdmp:document-get($location as xs:string) as node() external;
declare %a:since("marklogic", "5.0") function xdmp:document-get($location as xs:string, $options as node()?) as node() external;
...
declare %a:since("marklogic", "5.0") function xdmp:forest-counts($forest-id as xs:unsignedLong) as element(forest-counts) external;
declare %a:since("marklogic", "5.0") function xdmp:forest-counts($forest-id as xs:unsignedLong, $show-elements as xs:string*) as element(forest-counts) external;
...
declare %a:since("marklogic", "5.0") function xdmp:format-number($value as numeric, $picture as xs:string, $language as xs:string, $letter-value as xs:string, $ordchar as xs:string, $zero-padding as xs:string, $grouping-separator as xs:string, $grouping-size as xs:string) as xs:string external;
...
declare %a:since("marklogic", "5.0") function xdmp:get($path as xs:string) as node() external;
declare %a:since("marklogic", "5.0") function xdmp:get($path as xs:string, $default-namespace as xs:string?) as node() external;
declare %a:since("marklogic", "5.0") function xdmp:get($path as xs:string, $default-namespace as xs:string?, $options as xs:string*) as node() external;
...
declare %a:since("marklogic", "5.0") function xdmp:host-status($host-id as xs:unsignedLong) as element(host-status) external;
...
declare %a:since("marklogic", "5.0") function xdmp:parse-dateTime($picture as xs:string, $value as xs:string, $language as xs:string) as xs:dateTime external;
declare %a:since("marklogic", "5.0") function xdmp:parse-dateTime($picture as xs:string, $value as xs:string, $language as xs:string, $calendar as xs:string) as xs:dateTime external;
declare %a:since("marklogic", "5.0") function xdmp:parse-dateTime($picture as xs:string, $value as xs:string, $language as xs:string, $calendar as xs:string, $country as xs:string) as xs:dateTime external;
declare %a:since("marklogic", "5.0") function xdmp:parse-yymmdd($picture as xs:string, $value as xs:string) as xs:dateTime external;
declare %a:since("marklogic", "5.0") function xdmp:parse-yymmdd($picture as xs:string, $value as xs:string, $language as xs:string) as xs:dateTime external;
declare %a:since("marklogic", "5.0") function xdmp:parse-yymmdd($picture as xs:string, $value as xs:string, $language as xs:string, $calendar as xs:string) as xs:dateTime external;
declare %a:since("marklogic", "5.0") function xdmp:parse-yymmdd($picture as xs:string, $value as xs:string, $language as xs:string, $calendar as xs:string, $country as xs:string) as xs:dateTime external;
...
declare %a:since("marklogic", "5.0") function xdmp:set-transaction-name($name as xs:string, $host-id as xs:unsignedLong, $txn-id as xs:unsignedLong) as empty-sequence() external;
declare %a:since("marklogic", "5.0") function xdmp:set-transaction-time-limit($time-limit as xs:unsignedInt, $host-id as xs:unsignedLong, $txn-id as xs:unsignedLong) as empty-sequence() external;
...
declare %a:since("marklogic", "5.0") function xdmp:start-journal-archiving($forestIDs as unsignedInt*, $journal-archive-path as xs:string) as empty-sequence() external;
declare %a:since("marklogic", "5.0") function xdmp:start-journal-archiving($forestIDs as unsignedInt*, $journal-archive-path as xs:string, $lag-limit as xs:unsignedLong) as empty-sequence() external;
...
declare %a:since("marklogic", "5.0") function xdmp:stop-journal-archiving($forestIDs as unsignedLong) as empty-sequence() external;
...
declare %a:since("marklogic", "5.0") function xdmp:transaction($txn-name as xs:string, $host-id as xs:unsignedLong) as xs:unsignedLong* external;
