...
declare %a:since("marklogic", "7.0") function xdmp:database-partition-forests($value as item()) as xs:positiveInteger* external;
declare %a:since("marklogic", "7.0") function xdmp:database-path-namespaces($dbid as xs:ulong) as element() external;
...
declare %a:since("marklogic", "7.0") function xdmp:document-filter($doc as node(), $options as node()?) as node() external;
...
declare %a:since("marklogic", "7.0") function xdmp:external-security($external-security as xs:string) as xs:integer external;
...
declare %a:since("marklogic", "7.0") function xdmp:forest-counts($forest-id as xs:unsignedLong*, $show-elements as xs:string*, $options as xs:string*) as element(forest-counts) external;
...
declare %a:since("marklogic", "7.0") function xdmp:forest-online($forestID as unsignedLong) as xs:boolean external;
declare %a:since("marklogic", "7.0") function xdmp:forest-online($forestID as unsignedLong, $timestamp as unsignedLong) as xs:boolean external;
declare %a:since("marklogic", "7.0") function xdmp:forest-online($forestID as unsignedLong, $timestamp as unsignedLong, $isReplica as xs:boolean) as xs:boolean external;
declare %a:since("marklogic", "7.0") function xdmp:forest-online($forestID as unsignedLong, $timestamp as unsignedLong, $isReplica as xs:boolean, $syncingOk as xs:boolean) as xs:boolean external;
...
declare %a:since("marklogic", "7.0") function xdmp:invoke-function($path as function() as item()*) as item()* external;
declare %a:since("marklogic", "7.0") function xdmp:invoke-function($path as function() as item()*, $options as node()?) as item()* external;
...
declare %a:since("marklogic", "7.0") function xdmp:ldap-lookup($DN as xs:string, $options as node()?) as element()* external;
declare %a:since("marklogic", "7.0") function xdmp:ldap-search($query as xs:string) as element()* external;
declare %a:since("marklogic", "7.0") function xdmp:ldap-search($query as xs:string, $options as node()?) as element()* external;
...
declare %a:since("marklogic", "7.0") function xdmp:login($name as xs:string, $password as xs:string?, $set-session as xs:boolean?, $role-names as xs:string?) as xs:boolean external;
...
declare %a:since("marklogic", "7.0") function xdmp:plannable($expression as item()) as xs:boolean external;
...
declare %a:since("marklogic", "7.0") function xdmp:spawn-function($function as function() as item()*, $options as node()?) as item()* external;
...
declare %a:since("marklogic", "7.0") function xdmp:user($user as xs:string, $extSecId as xs:unsignedLong) as xs:integer external;
declare %a:since("marklogic", "7.0") function xdmp:user($user as xs:string, $extSecId as xs:unsignedLong, $secDbFirst as xs:boolean) as xs:integer external;
