...
declare %a:since("marklogic", "8.0") function geo:parse-wkt($wtk as xs:string*) as cts:region* external;
...
declare %a:since("marklogic", "8.0") function geo:to-wkt($wtk as cts:region*) as xs:string* external;
