...
declare %since("1.0", "20070123") function fn:QName($paramURI as xs:string?, $paramQName as xs:string) as xs:QName external;
declare %since("1.0", "20070123") function fn:abs($arg as xs:numeric?) as xs:numeric? external;
declare %since("1.0", "20070123") function fn:adjust-date-to-timezone($arg as xs:date?) as xs:date? external;
declare %since("1.0", "20070123") function fn:adjust-date-to-timezone($arg as xs:date?, $timezone as xs:dayTimeDuration?) as xs:date? external;
declare %since("1.0", "20070123") function fn:adjust-dateTime-to-timezone($arg as xs:dateTime?) as xs:dateTime? external;
...
declare %since("1.0", "20070123") function fn:boolean($arg as item()*) as xs:boolean external;
declare %since("1.0", "20070123") function fn:ceiling($arg as xs:numeric?) as xs:numeric? external;
declare %since("1.0", "20070123") function fn:codepoint-equal($comparand1 as xs:string?, $comparand2 as xs:string?) as xs:boolean? external;
declare %since("1.0", "20070123") function fn:codepoints-to-string($arg as xs:integer*) as xs:string external;
declare %since("1.0", "20070123") function fn:collection() as node()* external;
declare %since("1.0", "20070123") function fn:collection($arg as xs:string?) as node()* external;
declare %since("1.0", "20070123") function fn:compare($comparand1 as xs:string?, $comparand2 as xs:string?) as xs:integer? external;
declare %since("1.0", "20070123") function fn:compare($comparand1 as xs:string?, $comparand2 as xs:string?, $collation as xs:string) as xs:integer? external;
declare %since("1.0", "20070123") %variadic("xs:anyAtomicType?") function fn:concat($arg1 as xs:anyAtomicType?, $arg2 as xs:anyAtomicType?) as xs:string external;
declare %since("1.0", "20070123") function fn:contains($arg1 as xs:string?, $arg2 as xs:string?) as xs:boolean external;
declare %since("1.0", "20070123") function fn:contains($arg1 as xs:string?, $arg2 as xs:string?, $collation as xs:string) as xs:boolean external;
declare %since("1.0", "20070123") function fn:count($arg as item()*) as xs:integer external;
...
declare %since("1.0", "20070123") function fn:day-from-dateTime($arg as xs:dateTime?) as xs:integer? external;
declare %since("1.0", "20070123") function fn:days-from-duration($arg as xs:duration?) as xs:integer? external;
declare %since("1.0", "20070123") function fn:deep-equal($parameter1 as item()*, $parameter2 as item()*) as xs:boolean external;
declare %since("1.0", "20070123") function fn:deep-equal($parameter1 as item()*, $parameter2 as item()*, $collation as string) as xs:boolean external;
declare %since("1.0", "20070123") function fn:default-collation() as xs:string external;
declare %since("1.0", "20070123") function fn:distinct-values($arg as xs:anyAtomicType*) as xs:anyAtomicType* external;
...
declare %since("1.0", "20070123") function fn:error($error as xs:QName?, $description as xs:string, $error-object as item()*) as none external;
declare %since("1.0", "20070123") function fn:escape-html-uri($uri as xs:string?) as xs:string external;
...
declare %since("1.0", "20070123") function fn:id($arg as xs:string*) as element()* external;
declare %since("1.0", "20070123") function fn:id($arg as xs:string*, $node as node()) as element()* external;
declare %since("1.0", "20070123") function fn:idref($arg as xs:string*) as node()* external;
declare %since("1.0", "20070123") function fn:idref($arg as xs:string*, $node as node()) as node()* external;
declare %since("1.0", "20070123") function fn:implicit-timezone() as xs:dayTimeDuration external;
...
declare %since("1.0", "20070123") function fn:lang($testlang as xs:string?, $node as node()) as xs:boolean external;
declare %since("1.0", "20070123") function fn:last() as xs:integer external;
declare %since("1.0", "20070123") function fn:local-name() as xs:string external;
declare %since("1.0", "20070123") function fn:local-name($arg as node()?) as xs:string external;
declare %since("1.0", "20070123") function fn:local-name-from-QName($arg as xs:QName?) as xs:NCName? external;
declare %since("1.0", "20070123") function fn:lower-case($arg as xs:string?) as xs:string external;
declare %since("1.0", "20070123") function fn:matches($input as xs:string?, $pattern as xs:string) as xs:boolean external;
declare %since("1.0", "20070123") function fn:matches($input as xs:string?, $pattern as xs:string, $flags as xs:string) as xs:boolean external;
declare %since("1.0", "20070123") function fn:max($arg as xs:anyAtomicType*) as xs:anyAtomicType? external;
declare %since("1.0", "20070123") function fn:max($arg as xs:anyAtomicType*, $collation as string) as xs:anyAtomicType? external;
declare %since("1.0", "20070123") function fn:min($arg as xs:anyAtomicType*) as xs:anyAtomicType? external;
declare %since("1.0", "20070123") function fn:min($arg as xs:anyAtomicType*, $collation as string) as xs:anyAtomicType? external;
declare %since("1.0", "20070123") function fn:minutes-from-dateTime($arg as xs:dateTime?) as xs:integer? external;
declare %since("1.0", "20070123") function fn:minutes-from-duration($arg as xs:duration?) as xs:integer? external;
declare %since("1.0", "20070123") function fn:minutes-from-time($arg as xs:time?) as xs:integer? external;
declare %since("1.0", "20070123") function fn:month-from-date($arg as xs:date?) as xs:integer? external;
declare %since("1.0", "20070123") function fn:month-from-dateTime($arg as xs:dateTime?) as xs:integer? external;
declare %since("1.0", "20070123") function fn:months-from-duration($arg as xs:duration?) as xs:integer? external;
declare %since("1.0", "20070123") function fn:name() as xs:string external;
declare %since("1.0", "20070123") function fn:name($arg as node()?) as xs:string external;
declare %since("1.0", "20070123") function fn:namespace-uri() as xs:anyURI external;
...
declare %since("1.0", "20070123") function fn:normalize-unicode($arg as xs:string?) as xs:string external;
declare %since("1.0", "20070123") function fn:normalize-unicode($arg as xs:string?, $normalizationForm as xs:string) as xs:string external;
declare %since("1.0", "20070123") function fn:not($arg as item()*) as xs:boolean external;
...
declare %since("1.0", "20070123") function fn:replace($input as xs:string?, $pattern as xs:string, $replacement as xs:string) as xs:string external;
declare %since("1.0", "20070123") function fn:replace($input as xs:string?, $pattern as xs:string, $replacement as xs:string, $flags as xs:string) as xs:string external;
declare %since("1.0", "20070123") function fn:resolve-QName($qname as xs:string?, $element as element()) as xs:QName? external;
declare %since("1.0", "20070123") function fn:resolve-uri($relative as xs:string?) as xs:anyURI? external;
declare %since("1.0", "20070123") function fn:resolve-uri($relative as xs:string?, $base as xs:string) as xs:anyURI? external;
declare %since("1.0", "20070123") function fn:reverse($arg as item()*) as item()* external;
...
declare %since("1.0", "20070123") function fn:string-to-codepoints($arg as xs:string?) as xs:integer* external;
declare %since("1.0", "20070123") function fn:subsequence($sourceSeq as item()*, $startingLoc as xs:double) as item()* external;
declare %since("1.0", "20070123") function fn:subsequence($sourceSeq as item()*, $startingLoc as xs:double, $length as xs:double) as item()* external;
declare %since("1.0", "20070123") function fn:substring($sourceString as xs:string?, $startingLoc as xs:double) as xs:string external;
declare %since("1.0", "20070123") function fn:substring($sourceString as xs:string?, $startingLoc as xs:double, $length as xs:double) as xs:string external;
declare %since("1.0", "20070123") function fn:substring-after($arg1 as xs:string?, $arg2 as xs:string?) as xs:string external;
declare %since("1.0", "20070123") function fn:substring-after($arg1 as xs:string?, $arg2 as xs:string?, $collation as xs:string) as xs:string external;
declare %since("1.0", "20070123") function fn:substring-before($arg1 as xs:string?, $arg2 as xs:string?) as xs:string external;
...
declare %since("1.0", "20070123") function fn:tokenize($input as xs:string?, $pattern as xs:string) as xs:string* external;
declare %since("1.0", "20070123") function fn:tokenize($input as xs:string?, $pattern as xs:string, $flags as xs:string) as xs:string* external;
declare %since("1.0", "20070123") function fn:trace($value as item()*, $label as xs:string) as item()* external;
...
declare %since("1.0", "20070123") function fn:zero-or-one($arg as item()*) as item()? external;
