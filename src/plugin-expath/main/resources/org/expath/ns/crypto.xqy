...
declare %a:restrict-since("$key", "expath-crypto", "1.0-20110810", "xs:string")
        ...
        %a:restrict-since("$message", "basex", "9.3", "xs:anyAtomicType")
...
declare %a:restrict-since("$input", "basex", "9.3", "xs:anyAtomicType")
        %a:restrict-since("$key", "basex", "9.3", "xs:anyAtomicType")
        %a:since("expath-crypto", "1.0-20110810") function crypto:encrypt($input as xs:string, $encoding as xs:string, $key as xs:string, $algorithm as xs:string) as xs:string external;
declare %a:restrict-since("$input", "basex", "9.3", "xs:anyAtomicType")
        %a:restrict-since("$key", "basex", "9.3", "xs:anyAtomicType")
        %a:since("expath-crypto", "1.0-20110810") function crypto:decrypt($input as xs:string, $type as xs:string, $key as xs:string, $algorithm as xs:string) as xs:string external;
