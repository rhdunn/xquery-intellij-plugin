...
public class SyntaxHighlighterTest extends TestCase {
    ...
    public void testTokenHighlights_Keywords() {
        ...
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_ATTRIBUTE_DECL).length, is(1));
        ...
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_COMPLEX_TYPE).length, is(1));
        ...
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_CONTENT).length, is(1));
        ...
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_DIACRITICS).length, is(1));
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_DIACRITICS)[0], is(SyntaxHighlighter.KEYWORD));

        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_DIFFERENT).length, is(1));
        ...
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_ELEMENT_DECL).length, is(1));
        ...
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_ENTIRE).length, is(1));
        ...
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_FUZZY).length, is(1));
        ...
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_INSENSITIVE).length, is(1));
        ...
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_LANGUAGE).length, is(1));
        ...
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_LEVELS).length, is(1));
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_LEVELS)[0], is(SyntaxHighlighter.KEYWORD));

        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_LOWERCASE).length, is(1));
        ...
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_NO).length, is(1));
        ...
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_PARAGRAPH).length, is(1));
        ...
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_RELATIONSHIP).length, is(1));
        ...
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_SAME).length, is(1));
        ...
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_SCHEMA_COMPONENT).length, is(1));
        ...
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_SCHEMA_FACET).length, is(1));
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_SCHEMA_FACET)[0], is(SyntaxHighlighter.KEYWORD));

        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_SCHEMA_PARTICLE).length, is(1));
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_SCHEMA_PARTICLE)[0], is(SyntaxHighlighter.KEYWORD));

        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_SCHEMA_ROOT).length, is(1));
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_SCHEMA_ROOT)[0], is(SyntaxHighlighter.KEYWORD));

        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_SCHEMA_TYPE).length, is(1));
        ...
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_SENSITIVE).length, is(1));
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_SENSITIVE)[0], is(SyntaxHighlighter.KEYWORD));

        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_SENTENCE).length, is(1));
        ...
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_SIMPLE_TYPE).length, is(1));
        ...
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_STEMMING).length, is(1));
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_STEMMING)[0], is(SyntaxHighlighter.KEYWORD));

        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_STOP).length, is(1));
        ...
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_THEN).length, is(1));
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_THEN)[0], is(SyntaxHighlighter.KEYWORD));

        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_THESAURUS).length, is(1));
        ...
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_TUPLE).length, is(1));
        ...
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_UPPERCASE).length, is(1));
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_UPPERCASE)[0], is(SyntaxHighlighter.KEYWORD));

        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_USING).length, is(1));
        ...
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_WILDCARDS).length, is(1));
        ...
        assertThat(highlighter.getTokenHighlights(XQueryTokenType.K_WITHOUT).length, is(1));
