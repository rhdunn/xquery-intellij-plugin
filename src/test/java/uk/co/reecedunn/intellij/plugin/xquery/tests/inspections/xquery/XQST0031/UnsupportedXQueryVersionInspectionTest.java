...
public class UnsupportedXQueryVersionInspectionTest extends InspectionTestCase {
    ...
    public void testNoVersionDecl() {
        final XQueryModule file = parseResource("tests/inspections/xquery/XQST0031/no-versiondecl.xq");
    ...
    public void testEmptyVersionDecl() {
        final XQueryModule file = parseResource("tests/inspections/xquery/XQST0031/empty-version.xq");
    ...
    public void testXQueryVersion_UNSUPPORTED() {
        ...
        final XQueryModule file = parseResource("tests/inspections/xquery/XQST0031/xquery-3.99.xq");
    ...
    public void testUnsupportedVersion() {
        ...
        final XQueryModule file = parseResource("tests/inspections/xquery/XQST0031/xquery-9.7.xq");
    ...
    public void testSupportedVersion_MarkLogic() {
        ...
        final XQueryModule file = parseResource("tests/inspections/xquery/XQST0031/xquery-1.0-ml.xq");
    ...
    public void testUnsupportedVersion_MarkLogic() {
        ...
        final XQueryModule file = parseResource("tests/inspections/xquery/XQST0031/xquery-3.0.xq");
    ...
    public void testTransactions_SameVersion_W3C() {
        ...
        final XQueryModule file = parseResource("tests/inspections/xquery/XQST0031/transaction-same-version.xq");
    ...
    public void testTransactions_UnsupportedOtherVersion() {
        ...
        final XQueryModule file = parseResource("tests/inspections/xquery/XQST0031/transaction-unsupported-other-version.xq");
    ...
    public void testTransactions_DifferentVersions() {
        ...
        final XQueryModule file = parseResource("tests/inspections/xquery/XQST0031/transaction-different-version.xq");
