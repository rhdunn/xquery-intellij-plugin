...
public class XQueryParserTest extends ParserTestCase {
    ...
    public void testTryClause_MissingExpr() {
        ...
        final XQueryFile actual = parseResource("tests/parser/xquery-3.0/TryClause_MissingExpr.xq");
        assertThat(prettyPrintASTNode(actual), is(expected));
    }
    ...
    public void testCompNamespaceConstructor_MissingURIExpr() {
        ...
        final XQueryFile actual = parseResource("tests/parser/xquery-3.0/CompNamespaceConstructor_MissingURIExpr.xq");
        assertThat(prettyPrintASTNode(actual), is(expected));
    }
