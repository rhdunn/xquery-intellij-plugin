...
public class XQueryPsiTest extends ParserTestCase {
    ...
    // endregion
    // region EnclosedExpr (ExtensionExpr)

    public void testEnclosedExpr_ExtensionExpr() {
        final XQueryFile file = parseResource("tests/parser/xquery-1.0/ExtensionExpr.xq");

        XQueryExtensionExpr extensionExprPsi = descendants(file).findFirst(XQueryExtensionExpr.class).get();
        XQueryEnclosedExpr enclosedExprPsi = children(extensionExprPsi).findFirst(XQueryEnclosedExpr.class).get();
        XQueryConformanceCheck versioned = (XQueryConformanceCheck)enclosedExprPsi;
    ...
    public void testEnclosedExpr_ExtensionExpr_NoExpr() {
        final XQueryFile file = parseResource("tests/parser/xquery-1.0/ExtensionExpr_EmptyExpr.xq");
    ...
    // endregion
    // region EnclosedExpr (ValidateExpr)

    public void testEnclosedExpr_ValidateExpr() {
        ...
        XQueryEnclosedExpr enclosedExprPsi = children(validateExprPsi).findFirst(XQueryEnclosedExpr.class).get();
        XQueryConformanceCheck versioned = (XQueryConformanceCheck)enclosedExprPsi;
    ...
    public void testEnclosedExpr_ValidateExpr_NoExpr() {
        final XQueryFile file = parseResource("tests/parser/xquery-3.1/ValidateExpr_MissingExpr.xq");
