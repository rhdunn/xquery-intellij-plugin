...
public class XQueryLexerTest extends TestCase {
    ...
    public void testXQDoc_DirElemConstructor() {
        ...
        matchToken(lexer, "three",  31, 19, 24, XQueryTokenType.COMMENT);
        matchToken(lexer, "</",     31, 24, 26, XQueryTokenType.XQDOC_CLOSE_XML_TAG);
        matchToken(lexer, "two",    34, 26, 29, XQueryTokenType.XQDOC_XML_TAG_NAME);
        matchToken(lexer, " ",      34, 29, 30, XQueryTokenType.WHITE_SPACE);
        matchToken(lexer, ">",      34, 30, 31, XQueryTokenType.XQDOC_END_XML_TAG);
    ...
    public void testXQDoc_DirAttrConstructor() {
        ...
        matchToken(lexer, "three",  31, 38, 43, XQueryTokenType.COMMENT);
        matchToken(lexer, "</",     31, 43, 45, XQueryTokenType.XQDOC_CLOSE_XML_TAG);
        matchToken(lexer, "two",    34, 45, 48, XQueryTokenType.XQDOC_XML_TAG_NAME);
        matchToken(lexer, " ",      34, 48, 49, XQueryTokenType.WHITE_SPACE);
        matchToken(lexer, ">",      34, 49, 50, XQueryTokenType.XQDOC_END_XML_TAG);
