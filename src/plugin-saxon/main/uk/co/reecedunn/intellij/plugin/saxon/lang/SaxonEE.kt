...
object SaxonEE : XpmProductType {
    ...
    val VERSION_9_8: XpmProductVersion = SaxonVersion(this, 9, 8, "tuple(), union(), declare type, orElse, andAlso, fn{...}")
    val VERSION_9_9: XpmProductVersion = SaxonVersion(this, 9, 9, "calling java functions with '\$o?f()'")
    val VERSION_10_0: XpmProductVersion = SaxonVersion(this, 10, 0, ".{...}, _{$1}, otherwise, type(c), element(*:test), for member")
