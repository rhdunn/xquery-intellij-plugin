 ...
 */
package uk.co.reecedunn.intellij.plugin.saxon.model
...
private object SaxonBuiltInFunctionFileSystem : VirtualFileSystemImpl("res") {
...
object BuiltInFunctions : ImportPathResolver {
    ...
    override fun resolve(path: String): VirtualFile? {
        return MODULES[path]?.let { SaxonBuiltInFunctionFileSystem.findFileByPath(it) }
    }
