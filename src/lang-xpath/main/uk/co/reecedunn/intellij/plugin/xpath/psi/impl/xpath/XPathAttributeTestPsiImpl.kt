...
class XPathAttributeTestPsiImpl(node: ASTNode) :
    ASTWrapperPsiElement(node), XpmSyntaxValidationElement, XPathAttributeTest {
    companion object {
    ...
    override val typeName: String
        get() = computeUserDataIfAbsent(TYPE_NAME) {
            ...
            when {
                ...
                type == null -> "attribute(${qname_presentation(name)})"
                else -> "attribute(${qname_presentation(name)},${type.typeName})"
            }
        }
